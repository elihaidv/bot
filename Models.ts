...
export class SignalingType {
  ...
  stopPrice
  longTerm
  constructor(regex: string, coin1: number, coin2: number, direction: number, leverage: number, enterPriceStart: number, enterPriceEnd: number,  takeProfitStart: number, takeProfitEnd: number, stop: number,longTerm: string) {
    this.regex = regex
    this.coin1 = coin1
    this.coin2 = coin2
