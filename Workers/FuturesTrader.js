...
var FutureTrader = /** @class */ (function (_super) {
    ...
    FutureTrader.prototype.placeBuy = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var buyPrice, buyQu, maxBuyPrice, balanceLeveraged, params;
                ...
                switch (_h.label) {
                    case 0:
                        ...
                        if (this.isFirst()) {
                            ...
                            buyPrice = ((_c = this.myLastOrder) === null || _c === void 0 ? void 0 : _c.avgPrice) * this.sub(1, this.bot.take_profit);
                        }
                        else {
                            buyPrice = ((_d = this.myLastOrder) === null || _d === void 0 ? void 0 : _d.avgPrice) * this.sub(1, this.bot.last_distance);
                        }
