...
var BaseSockets = /** @class */ (function () {
    ...
    BaseSockets.prototype.updatePricesSockets = function () {
        ...
        if (this.chartsSocket)
            this.binance.websockets.terminate(this.chartsSocket);
        this.chartsSocket = this.binance.websockets.chart(this.pairs, "5m", function (symbol, interval, chart) {
            return _this.prices[symbol] = Object.values(chart).map(function (c) { return c.close; }).reverse();
        });
        this.chartsSocket = this.binance.websockets.chart(this.pairs, "15m", function (symbol, interval, chart) {
