...
exports.DirectionTrader = void 0;
var FuturesTrader_1 = require("./FuturesTrader");
var Models_1 = require("../Models");
var DirectionTrader = /** @class */ (function (_super) {
    __extends(DirectionTrader, _super);
    function DirectionTrader() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DirectionTrader.prototype.place = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.binance || !this.balance[this.SECOND] || !this.futureSockets.prices[this.PAIR] || !this.orders || !this.orders.length)
                            return [2 /*return*/];
                        ...
                        this.calculatePrice();
                        this.buildHistory();
                        if (!!this.positionAmount) return [3 /*break*/, 3];
    ...
    DirectionTrader.prototype.placeBuy = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var buyPrice, buyQu, maxBuyPrice, balanceLeveraged;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.place_order(this.SECOND, Math.abs(buyQu), 0, !this.bot.direction, {
                                type: "STOP_MARKET",
    ...
    DirectionTrader.prototype.placeSell = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        maxBuyPrice = (_a = this.futureSockets.ticker(this.PAIR)) === null || _a === void 0 ? void 0 : _a.bestBid;
                        price = this.positionEntry * this.add(1, this.bot.callbackRate / 100);
                        return [4 /*yield*/, this.place_order(this.PAIR, this.positionAmount * 2, 0, this.bot.direction, {
                    ...
                    case 2:
                        _b.sent();
                        if (!this.error) return [3 /*break*/, 4];
...
exports.DirectionTrader = DirectionTrader;
