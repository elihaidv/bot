            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fs_1.promises.mkdir("spot/" + pair + "/" + unit, { recursive: true })];
                    case 1:
                        _a.sent();
                        fs_1.promises.writeFile("spot/" + pair + "/" + unit + "/" + date + ".csv", historyArray.map(function (e) { return e.join(','); }).join('\n'), {});
                        // await new Storage()
        ...
        this.getHistoryFromBucket = function (pair, unit, date) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs_1.promises.readFile("spot/" + pair + "/" + unit + "/" + date + ".csv")
                    ...
                    case 1:
                        ...
                        //     .file(`spot/${pair}/${unit}/${date}.csv`)
                        //     .download()
                        return [2 /*return*/, file.toString().split("\n")
                                .map(function (x) { return x.split(",")
                                .map(function (y) { return parseFloat(y); }); })];
                    case 2:
                        e_3 = _a.sent();
