...
var FutureDataManager = /** @class */ (function (_super) {
    ...
    FutureDataManager.prototype.orderexecute = function (order, t) {
        ...
        console.log("Variation: " + node_process_1.env.JOB_COMPLETION_INDEX + "Profit: " + (this.profit / 100).toFixed(2) + "% Date: " + new Date(parseInt(this.chart[this.currentCandle].time)));
